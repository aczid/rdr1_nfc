...
The security architecture of NFC-based applications have to take into account the hostile environment a modern mobile phone can be exposed to, which sparked our interest in its design.
