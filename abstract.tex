...
Mobile devices could become a viable target for hackers, as they are exposed to the outside world through an expanding set of features and run more and more software packages.
Reviewing the literature, we can conclude that while NFC applications can be implemented in a secure manner, the deployment in mobile devices implies risks and limitations hindering their adoption.
\end{abstract}
