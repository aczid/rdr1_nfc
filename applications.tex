...
The SE will store the eVouchers and also encrypt them, if a user decides to sent them to another user. \cite{1592613} %TODO nazoeken of dit klopt zo, dat ze ook via sms gedistributeerd worden
...
As we will see later on, this can create a security problem for a user that is unaware. \cite{10.1109/ARES.2009.46}
