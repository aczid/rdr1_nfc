...
%TODO rewrite
Another possibility is to create an offline payment system with the use of cryptographically signed vouchers in a \textit{Public Key Infrastructure}. \cite{rivest1978method}
