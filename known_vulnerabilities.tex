...
% the specified operational distance - where is this specified? A standard? Which standard?
...
\cite{mulliner2009vulnerability,rieback2006your} %TODO fix
...
The information is statistically analyzed to determine the key or plaintext, or it can give information about the key, which can help to speed up the attack or help a different attack to succeed. %TODO which attack?

DPA can also be applied for electromagnetic radiation. %TODO note DFA
