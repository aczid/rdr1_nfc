...
NFC will allow a mobile device to communicate wirelessly over a short distance with other NFC-capable devices such as another smartphone, a payment terminal, a so-called 'smart poster' or an access control terminal. The user will, respectively, pay for an item or transfer money, recieve more information or gain access to public transport.
