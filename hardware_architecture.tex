...
\textit{Integrated Circuit Cards} (ICCs) can mitigate this problem by storing a secret key known only to the bank which is used to sign transactions.
ICCs, commonly known as smart cards, can be issued with various anti-tampering mechanisms, adding to the intrinsic tamper-resistance of the embedded microchip itself due to its small scale. \cite{kömmerling1999design}
