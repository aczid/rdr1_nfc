...
A mobile device has some advantages over a card, i.e. you can check the balance on your mobile device and increase it immediately by paying online. %MARK niet zo lekker stukje kan een bron bij, maar wat voor IEEE, ACM, scholar? Nog geen pilot in nederland :(
...
In this de-facto standard for mobile payment the mobile device emulates the behaviour of an RFID card, but in the future much more is possible by making use of the active communication possibilities of NFC. % ERIK: Wat bedoel je hiermee?
